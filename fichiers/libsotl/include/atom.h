...
/**
 *  Permet de recuperer le tableau de la somme prefixee des boites
 */
int *atom_get_num_box_array(const sotl_domain_t *dom, const sotl_atom_set_t *set);

/**
 * Fonction du tri par boite. A près execution les atomes sont triés selon leur numero de boite
 */
